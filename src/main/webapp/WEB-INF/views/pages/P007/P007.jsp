		...
		<jsp:include page="../../layout/header.jsp" />
   		...
   		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>P007 <small>report pdf</small></h1>
				<jsp:include page="../../commons/servertime.jsp" />
			</section>
			
			<!-- CONTENT BODY -->
   			<section class="content">
				<a href="../export/user.pdf" target="_blank">Test</a>
				<a href="../export/province90.pdf" target="_blank">province</a>
   			</section>
...
<script src="${pageContext.request.contextPath}/resources/scripts/P007.js"></script>
<script>
