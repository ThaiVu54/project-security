	        	...
	        	<div class="col-md-3">
	        		<div class="form-group">
				        ...
				        <div class="input-group date">
					    	...
					    	<input name="xxxx" type="text" class="form-control" placeholder="Province...">
					    </div>
					</div>
	        	</div>
	        	<div class="col-md-3">
	        		<div class="form-group">
				        ...
				        <div class="input-group date">
					    	...
					    	<input name="xxx" type="text" class="form-control" placeholder="District...">
					    </div>
					</div>
	        	</div>
	        	<div class="col-md-3">
	        		<div class="form-group">
				        ...
				        <div class="input-group date">
					    	...
					    	<input name="xxx" type="text" class="form-control" placeholder="Sub District...">
					    </div>
					</div>
	        	</div>
	        	<div class="col-md-3">
